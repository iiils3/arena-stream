...
export class ArenaRoom extends Room<ArenaState> {
 ...
 private inputs=new Map<string,Input>(); private timers=new Map<string,ReturnType<typeof setTimeout>>(); private attacks=new Map<string,number>();
 onCreate(){
 ...
 private event(){const name=EVENTS[this.state.eventIndex++%EVENTS.length];this.state.activeEvent=name;this.state.lastEvent=`الجمهور اختار: ${name}`;
